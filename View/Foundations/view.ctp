...
?>&nbsp;
    ...
    <div class="actions">
        <ul>
            ...
            <li><?php echo $this->Html->link(__('View Related Directors', true), array('controller' => 'directors', 'action' => 'index', 'Foundation', $this->data['Foundation']['id']), array('class' => 'FoundationsViewControl')); ?></li>
        </ul>
    </div>
    <div id="FoundationsViewPanel"></div>
    <script type="text/javascript">
        //<![CDATA[
        $(function() {
            $('a.FoundationsViewControl').click(function() {
                $('#FoundationsViewPanel').parent().load(this.href);
                return false;
            });
        });
        //]]>
